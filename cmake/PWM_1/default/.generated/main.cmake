...
add_executable(PWM_1_default_image_Mem1MNkX ${PWM_1_default_library_list})

set_target_properties(PWM_1_default_image_Mem1MNkX PROPERTIES
    OUTPUT_NAME "default"
    SUFFIX ".elf"
    RUNTIME_OUTPUT_DIRECTORY "${PWM_1_default_output_dir}")
target_link_libraries(PWM_1_default_image_Mem1MNkX PRIVATE ${PWM_1_default_default_XC16_FILE_TYPE_link})

# Add the link options from the rule file.
PWM_1_default_link_rule( PWM_1_default_image_Mem1MNkX)

# Call bin2hex function from the rule file
PWM_1_default_bin2hex_rule(PWM_1_default_image_Mem1MNkX)
