...
add_executable(assignment1_last_default_image_pUEi2Fcg ${assignment1_last_default_library_list})

set_target_properties(assignment1_last_default_image_pUEi2Fcg PROPERTIES
    OUTPUT_NAME "default"
    SUFFIX ".elf"
    RUNTIME_OUTPUT_DIRECTORY "${assignment1_last_default_output_dir}")
target_link_libraries(assignment1_last_default_image_pUEi2Fcg PRIVATE ${assignment1_last_default_default_XC16_FILE_TYPE_link})

# Add the link options from the rule file.
assignment1_last_default_link_rule( assignment1_last_default_image_pUEi2Fcg)

# Call bin2hex function from the rule file
assignment1_last_default_bin2hex_rule(assignment1_last_default_image_pUEi2Fcg)
